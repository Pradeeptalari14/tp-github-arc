# 🏃 GitHub ARC Studio
> Deploy event-driven horizontal actions runners using Actions Runner Controller (ARC). Define runner boundaries and simulate dynamic container scaling.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/github-arc/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/github-arc/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-github-arc.git
cd tp-github-arc
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/github-arc/) |
